...
if "-judge" not in sys.argv:
    print("\nOnline Judge : Execution Protocol")
...
sql_hostport = 3306
sql_username = "rafid41"
sql_password = "11111"
sql_database = "pstu_oj"
    ...
    try:
        ...
        if result == None:
            ...
            if output == correct:
                ...
                #change PE,AC
                result = "AC" if "P" in run["output"] else "AC"
            else:
                result = "WA"
...
if __name__ == "__main__":
    ...
    # Terminate
    print("Online Judge : Execution Protocol Terminated.\n")
