    ...
    <body class="text-gray-800 antialiased">
        <div class="w-4/5 bg-white rounded-lg shadow-lg p-6 py-4">
            <div class="text-center py-6">
                <h1 class="text-3xl font-bold text-blue-700">Add Topic</h1>
            </div>
            <form class="max-w-4xl mx-auto mt-8" method="post" action="<?php echo SITE_URL; ?>/process.php" enctype='multipart/form-data'>
                <div class="mx-auto bg-white border border-grey-300 rounded rounded-lg shadow-lg p-6 py-4">
                    <div class="mb-4">
                        <label for="title" class="block text-gray-700 font-bold mb-2 flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">Title</label>
                    ...
                    <div class="w-full mb-4">
                            <label for="statement_file" class="block text-gray-700 font-bold mb-2">Statement File</label>
                            <input class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" type="file" name="statement_file" id="statement_file">
