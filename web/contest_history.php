    ...
    <?php
                    ...
                    if ($rankTable) {
                        foreach ($rankTable as $row) {
                            ...
                            $time = $row['time'];
                            $table .= '<tr>';
                            $table .= '<td class="px-4 py-2 border text-center">' . $rank . '</td><td class="px-4 py-2 border text-center"><a href="' . SITE_URL . '/profile.php?id=' . $row['username'] . '" class="text-blue-600">' . $row['username'] . '</a></td><td class="px-4 py-2 border text-center">' . $row['score'] . '</td><td class="px-4 py-2 border text-center">' . $solvedCount . '</td><td class="px-4 py-2 border text-center">' . gmdate("H:i:s", $time) . '</td>';
                            $table .= '</tr>';
                            if ($rank >= $limit) break;
                            $rank++;
                        }
