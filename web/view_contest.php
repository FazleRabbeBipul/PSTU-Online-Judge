            ...
            <script type='text/javascript'>
                ...
                function timer() {
                    if (ctime > 0) {
                        ...
                        var minutes = Math.floor((ctime % 3600) / 60);
                        var seconds = ctime % 60;

                        document.getElementById("contesttimer").innerHTML = "<h4 class='timer'>Time remaining: " + zeroPad(hours, 2) + ":" + zeroPad(minutes, 2) + ":" + zeroPad(seconds, 2) + "</h4>";
                        ctime--;
                        window.setTimeout(timer, 1000);
                    } else {
                        document.getElementById("contesttimer").innerHTML = "<h4 class='timer'>Contest is over.</h4>";
                    }
                }
                timer();
            </script>
